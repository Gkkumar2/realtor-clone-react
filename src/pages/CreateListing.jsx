      ...
      <form>
        ...
        <div className="flex">
          <button
            ...
            value="rent"
            onClick={onChange}
            className={`px-7 py-3 mr-3 font-medium text-sm uppercase shadow-md rounded 
              hover:shadow-lg focus:shadow-lg 
              active:shadow-lg transition
               duration-100 ease-in-out w-full ${
                 type === "rent"
                   ? "bg-white text-black"
          ...
          <button
            ...
            value="sale"
            onClick={onChange}
            className={`px-7 py-3 ml-3 font-medium text-sm uppercase shadow-md rounded 
              hover:shadow-lg focus:shadow-lg 
              active:shadow-lg transition
               duration-100 ease-in-out w-full ${
                 type === "sale"
        ...
        <input
          ...
          className="w-full px-4 py-2 text-xl text-gray-700
           bg-whight border border-gray-300 rounded 
          ...
          <div className="">
            ...
            <div className="flex w-full justify-center items-center space-x-6">
              <input
                ...
                text-xl text-gray-700 bg-white border border-gray-300 rounded transition
                duration-150 ease-in-out focus:text-gray-700 focus:bg-white
                 focus:border-salte-600 text-center"
              />
              {type === "rent" && (
                <div className="">
                  <p className="text-md w-full white">$/months</p>
                </div>
              )}
            </div>
          </div>
        ...
        <div>
            <button type ="submit" className="
             mb-6 w-full px-7 py-3
             bg-blue-600 text-white 
             font-medium text-sm uppercase rounded 
             shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg active:bg-blue-50
