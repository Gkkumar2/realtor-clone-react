...
export default function Signin() {
  ...
  return (
    <section>
      ...
      <div className="md:w-[67%] lg:w-[50%] mb-12 md:mb-36 lg:mb-0"> {/* Adjusted margin for larger screens */}
          <img
            ...
            alt=""
            className="w-full rounded items-center"
          />
        </div>
        <div className="w-full md:w-[67%] lg:w-[40%] lg:ml-20 items-center justify-center">
          <form>
            <input
              type="email"
